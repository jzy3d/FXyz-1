...
public class JavaFXPlotBuilder extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        setupCamera(sceneRoot, scene, cameraInitTranslateZ);
        ...
        int size = 10;
        int spacing = 100;
        addWireframe(sceneRoot, size/2, spacing);
    ...
    private void addWireframe(Group sceneRoot, int size, int spacing) {
        ...
        SurfacePlot surfacePlot = new SurfacePlot(mesh, arrayY.length, Color.AQUA, false, true);
