...
public class AxeBox extends Group {
    ...
    public AxeBox(double axesSize, double spacing, boolean selfLight, double scatterRadius, double axesThickness, double gridSize) {
    ...
    private void buildPanels(double size) {
        // @SMP TODO might be easier to just replace the Rectangle side panels
        // with really flat Box 3D objects
    ...
    public void setxAxisData(ArrayList<Double> data) {
        ...
        for (int i = 0; i < xAxisData.size(); i++) {
            ...
            // final Box dataSphere = new Box(getScatterRadius(),
            // getScatterRadius(), getScatterRadius());
    ...
    /**
     * @param selfLightEnabled
     *            the selfLightEnabled to set
     */
